 ...
 * The Wardrobe prop object contains final variables WIDTH and HEIGHT to set the dimensions in pixels of the prop when drawn on screen.
 * The final String wardrobeFilePath designates the file path where the .png file is stored for drawing the prop on screen.
 ...
 */
public class Wardrobe extends Prop{
	
	public static final int WIDTH = 47, HEIGHT = 82;
	public static final String wardrobeFilePath = "/assets/Wardrobe.png";
	 ...
	 */
	public Wardrobe(int x, int y, PropObjectID id, Pane pane, ObjectController objControl) {
		super(x, y, HEALTH, "/assets/Wardrobe.png", WIDTH, HEIGHT, id, pane, objControl);
		this.filePath = getClass().getResource(wardrobeFilePath).toString();
		this.height = HEIGHT;
		this.width = WIDTH;
