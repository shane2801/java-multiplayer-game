 ...
 * The SilverFridge prop object contains final variables WIDTH and HEIGHT to set the dimensions in pixels of the prop when drawn on screen.
 * The final String silverFridgeFilePath designates the file path where the .png file is stored for drawing the prop on screen.
 ...
 */
public class SilverFridge extends Prop {
	
	public static final int WIDTH = 47, HEIGHT = 82;
	public static final String silverFridgeFilePath = "/assets/SilverFridge.png";
	 ...
	 */
	public SilverFridge(int x, int y, PropObjectID id, Pane pane, ObjectController objControl) {
		super(x, y, HEALTH, "/assets/SilverFridge.png", WIDTH, HEIGHT, id, pane, objControl);
		this.filePath = getClass().getResource(silverFridgeFilePath).toString();
		this.height = HEIGHT;
		this.width = WIDTH;
