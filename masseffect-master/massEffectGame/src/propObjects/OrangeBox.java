...
/**
 * @author joshua hamilton-brown, kavish muthoora,
 * the BlueFridge object is a prop object that is used in gameplay for hiders and seekers to interact with.
 * The OrangeBox prop object contains final variables WIDTH and HEIGHT to set the dimensions in pixels of the prop when drawn on screen.
 * The final String orangeBoxFilePath designates the file path where the .png file is stored for drawing the prop on screen.
 ...
 */
public class OrangeBox extends Prop {
	
	public static final int WIDTH = 82, HEIGHT = 26;//find way to load aspect ratio / resolution of image to draw.
	public static final String orangeBoxFilePath = "/assets/OrangeBox.png";
	 ...
	 */
	public OrangeBox(int x, int y, PropObjectID id, Pane pane, ObjectController objControl) {
		super(x, y, HEALTH, "/assets/OrangeBox.png", WIDTH, HEIGHT, id, pane, objControl);
		this.filePath = getClass().getResource(orangeBoxFilePath).toString();
		this.height = HEIGHT;
		this.width = WIDTH;
